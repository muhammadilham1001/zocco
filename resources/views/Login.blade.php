...
<body class="bg-slate-dark flex items-center justify-center min-h-screen p-4 relative overflow-hidden">
    ...
    <main
        ...
        <div
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-gray-400 text-sm font-light italic tracking-wide">
                    "Crafted Selection untuk melengkapi momen spesial Anda."
                </p>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center bg-slate-900/50">
            <div class="mb-10">
                <h1 class="font-serif text-3xl text-white italic mb-2">Selamat Datang</h1>
                <p class="text-gray-400 text-xs uppercase tracking-[0.2em]">Silakan masuk ke akun Anda</p>
            </div>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label
                        class="block text-[10px] font-bold uppercase tracking-widest text-yellow-zocco mb-2">Email</label>
                    <div class="relative">
                        <i data-lucide="mail"
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="nama@email.com"
                            required
                            class="input-zocco w-full pl-12 pr-4 py-3.5 rounded-xl text-sm @error('email') border-red-500 @enderror">
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between mb-2">
                        <label
                            class="text-[10px] font-bold uppercase tracking-widest text-yellow-zocco">Password</label>
                        <a href="{{ route('password.request') }}"
                            class="text-[10px] text-gray-500 hover:text-yellow-zocco transition font-bold uppercase tracking-widest">Lupa?</a>
                    </div>
                    <div class="relative">
                        <i data-lucide="lock"
                            class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500"></i>
                        <input type="password" name="password" placeholder="••••••••" required
                            class="input-zocco w-full pl-12 pr-4 py-3.5 rounded-xl text-sm">
                    </div>
                </div>
            ...
            <p class="text-center mt-10 text-[10px] text-gray-500 font-bold uppercase tracking-widest">
                Belum punya akun?
                <a href="{{ route('register') }}"
                    class="text-yellow-zocco hover:underline decoration-2 underline-offset-4">Daftar</a>
            </p>
        </div>
    </main>
