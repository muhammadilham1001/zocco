...
<head>
    ...
    <title>Lupa Password - Zocco</title>
...
<body class="bg-slate-dark flex items-center justify-center min-h-screen p-4 relative overflow-hidden">
    ...
    {{-- Efek Dekorasi Background (Sama dengan Login) --}}
    ...
    <main
        ...
        {{-- Sisi Kiri: Visual (Sama dengan Login) --}}
        <div
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center bg-slate-900/50">
            <div class="mb-10">
                <h1 class="font-serif text-3xl text-white italic mb-2">Lupa Password?</h1>
                <p class="text-gray-400 text-xs uppercase tracking-[0.2em]">Masukkan email untuk menerima kode OTP</p>
            </div>
            ...
            <form action="{{ route('password.email') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-widest text-yellow-zocco mb-2">Email
                        Terdaftar</label>
                    <div class="relative">
                        <i data-lucide="mail"
