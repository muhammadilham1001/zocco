...
<head>
    ...
    <title>Setel Ulang Password - Zocco</title>
    ...
    <main
        ...
        <div
            ...
            <div class="relative z-10 text-center">
                ...
                <h2 class="font-serif text-4xl text-white mb-4 italic uppercase tracking-tighter">New Beginnings.</h2>
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center bg-slate-900/50">
            <div class="mb-10">
                <h1 class="font-serif text-3xl text-white italic mb-2">Password Baru</h1>
                <p class="text-gray-400 text-xs uppercase tracking-[0.2em]">Masukkan password baru yang aman</p>
            </div>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-widest text-yellow-zocco mb-2">Password
                        Baru</label>
                    <div class="relative">
                        <i data-lucide="lock"
                            class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500"></i>
                        <input type="password" name="password" required
                            class="input-zocco w-full pl-12 pr-4 py-3.5 rounded-xl text-sm" placeholder="••••••••">
                    </div>
                </div>

                <div>
                    <label
                        class="block text-[10px] font-bold uppercase tracking-widest text-yellow-zocco mb-2">Konfirmasi
                        Password</label>
                    <div class="relative">
